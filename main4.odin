...
main :: proc() {
	...
	// }
	fmt.println("---------------------------------------")
	// fmt.println("offset_of:", offset_of(lxb.lxb_html_document_t, dom_document))
	// fmt.println("offset_of:", offset_of(lxb.lxb_html_document_t, iframe_srcdoc))
	// fmt.println("offset_of:", offset_of(lxb.lxb_html_document_t, head))
	// fmt.println("offset_of:", offset_of(lxb.lxb_html_document_t, body))
	// fmt.println("---------")
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, node))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, compat_mode))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, type))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, doctype))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, element))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, create_interface))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, clone_interface))
	// fmt.println("offset_of destroy:", offset_of(lxb.lxb_dom_document_t, destroy_interface))
	// // fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, node_cb))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, mraw))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, text))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, tags))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, attrs))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, prefix))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, ns))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, parser))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, user))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, tags_inherited))
	// fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, ns_inherited))
	fmt.println("offset_of:", offset_of(lxb.lxb_dom_document_t, scripting))
	...
	// fmt.printf("document.body adress: %d\n", document.body)
